...
public class Programm {
     ...
     * быть свойтва: марка, модель, цвет, тип кузова, число колёс, тип
     ...
     * 4. Рамширить абстрактный класс <<Car>>, добавить метод:
     * включение притивотуманных фар, перевозка груза. Провести
     ...
     * 11. Создать путём нследования класса "Car" два
    ...
    public static void main(String[] args) {
        ...
        Harvester harvester = new Harvester("Беларус", "МТЗ-80", "Синий");
        harvester.setRefueling(new RefuelingStation());
        harvester.setWiping(new CarWash());
